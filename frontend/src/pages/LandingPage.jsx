      ...
      <section className="py-28 px-4 relative">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-5">
            {[
              { step: '01', title: 'Upload Your Resume', desc: 'Drop your PDF or DOCX. Our LLM-powered parser strips every skill, technology, project, and experience into structured data in seconds.', img: 'https://images.unsplash.com/photo-1568667256549-094345857637?w=700&q=80&auto=format&fit=crop', reverse: false },
              { step: '02', title: 'Pick a Target Job', desc: 'Browse 1,369 curated real-world roles from top tech companies. Filter by domain, stack, or seniority to find the role that excites you.', img: 'https://images.unsplash.com/photo-1653387300291-bfa1eeb90e16?w=700&q=80&auto=format&fit=crop', reverse: true },
